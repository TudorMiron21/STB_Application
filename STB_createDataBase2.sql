...
CREATE DATABASE [STB_app]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'STB_app', FILENAME = N'D:\Scoala\Anul 2\SEM 2\Baze de date\MSSQL15.MSSQLSERVER\MSSQL\DATA\STB_app.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'STB_app_log', FILENAME = N'D:\Scoala\Anul 2\SEM 2\Baze de date\MSSQL15.MSSQLSERVER\MSSQL\DATA\STB_app_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
